...
{
  redirectVerifierToAuth();
}
$arCurrentPage = getCurrentPageVerifier($pageTitle);
define('DEF_BASE_URL', DEF_ROOT_PATH_VERIFIER.'/');
?>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item py-2">
            <a href="<?php echo DEF_BASE_URL; ?>app/verification" class="nav-link <?php echo $arCurrentPage['verification'];?>">
