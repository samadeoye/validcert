        ...
        <div class="row">
          <div class="col-md-12">
              <div class="card card-theme card-tabs">
                  ...
                  <div class="m-3">
                    <button class="btn btn-theme btn-sm" id="btnReloadVerificationHistoryTable"><i class="fas fa-redo"></i> Reload</button>
                  </div>
...
var verificationHistoryTable = $('#verificationHistoryTable').DataTable({
  ...
  info: false,
  lengthChange: false,
  ajax: baseUrl+'inc/actions?action=getcertificatesverifications&actionType=recent',
  columns: [
    { data: 'sn' },
    { data: 'issuer' },
    { data: 'holderName' },
